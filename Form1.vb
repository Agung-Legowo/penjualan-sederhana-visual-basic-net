Public Class Form1
    ...
    Private Sub Txtjumlah_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Txtjumlah.TextChanged
        ...
        If Val(Txtjumlah.Text) >= 5 Then
            Txtdiskon.Text = Val(Txttotal.Text) * 0.1
        ElseIf Val(Txtjumlah.Text) >= 3 Then
            Txtdiskon.Text = Val(Txttotal.Text) * 0.5
        Else
            Txtdiskon.Text = Val(Txttotal.Text) * 0

        End If
        Txttotalbayar.Text = Val(Txttotal.Text) = Val(Txtdiskon.Text)
    End Sub
